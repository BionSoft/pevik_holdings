...
class Listing(models.Model):
    ...
    property_type = models.CharField(max_length=50, choices=PropertyType.choices, default=PropertyType.HOUSES)
    ...
    video_file = models.FileField(upload_to='videos/%Y/%m/%d/', blank=True)
